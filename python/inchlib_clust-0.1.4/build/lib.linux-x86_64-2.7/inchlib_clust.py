...
if __name__ == '__main__':
    ...
    databaseArgs.add_argument("-db",    "--database",           default=False, help="required to allow database input", action="store_true")
    ...
    databaseArgs.add_argument("-dbs",   "--set_database",       default=False, metavar = "", type=str, help="Required if database is not supplied in the settings file or set a different database")
